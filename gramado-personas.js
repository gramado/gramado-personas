	...
	/* Entry point: Isso deve ser chamado apenas uma vez.*/
    ...
    {
        /*quatro objetos ... que terão vários métodos cada. */	
	    this.ux4 = 0;  /* Thinking */
	    this.ux3 = 0;  /* Logic */
	...
	/* administrando a biblioteca, funcionalidades administrativas da biblioteca */
	function ADMIN(){
	...
	/* manteremos a ordem dos objetos. */
    ...
    /*
	  do_validateForm:
          O objetivo desse método é capturar o input do form na página inicial, usado 
        na busca, compará lo com o banco de dados, apresentar o resultado 
        em outra página /search onde também será um mecanismo de pesquisa.		
	 */
    function do_validateForm()
	{
		...
		if( GET == ""){
			...
			/* ?? O que acontece no caso de retornar aqui ?? Voltamos à pagina inicial e 
			inicializamos a biblioteca, quando chega no elemento 'body' ??*/
            
			/*#bugbug Esse if está retornando.*/
			return 0;
        }else{
		    /*alert("GET != 0");*/
			/*alert(GET);*/
	...
	/* 
	   Esse método é para baixar um arquivo que foi construído em um form
	   com os inputs 'filename_input' e 'filetext_input' 
	   Para acionar esse método é usada a função 
	   >> gramado.admin.download();
	 */ 
